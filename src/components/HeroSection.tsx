        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start animate-slide-up animation-delay-600">
              ...
              <Button asChild className="h-14 rounded-full px-10 text-lg border-2 border-ksl-yellow/50 bg-[#2a2a2a] text-ksl-yellow font-bold tracking-widest hover:bg-[#333] hover:border-ksl-yellow transition-all shadow-none">
                <Link to="/translate" className="flex items-center gap-2">
                  <span className="bg-clip-text text-transparent bg-gradient-to-r from-ksl-yellow via-orange-400 to-ksl-yellow">
                    DEMO
                  </span>
                </Link>
              </Button>
